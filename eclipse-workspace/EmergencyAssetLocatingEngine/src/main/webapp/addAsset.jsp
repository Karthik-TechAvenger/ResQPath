...
<body>
	...
	<div class="container">
		<div class="card bg-white shadow-sm mt-5">
			...
			<form method="post" action="adminAction?action=addAsset">
				<div class="mb-3">
					<label for="type" class="form-label">Asset Type</label> <select
				...
				<div class="mt-4 d-flex justify-content-between">
					...
					<a class="btn btn-outline-secondary w-45 text-center"
						href="adminAction?action=viewAssets"> <i
						class="bi bi-card-list"></i> View Assets
					</a>
				</div>
			</form>
		</div>
